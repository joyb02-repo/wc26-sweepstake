...
st.markdown(
    ...
    <style>
        ...
        /* --------------------------------------------------------------------------------- */
        /* --- TARGET ONLY THE INFO SWEEPSTAKE EXPANDER USING ITS EXACT INNER HEADER TEXT --- */
        /* --------------------------------------------------------------------------------- */
        div[data-testid="stExpander"]:has(span:contains("ℹ️")) summary,
        div[data-testid="stExpander"]:has(p:contains("ℹ️")) summary {
        ...
        div[data-testid="stExpander"]:has(span:contains("ℹ️")) summary p,
        div[data-testid="stExpander"]:has(p:contains("ℹ️")) summary p {
            font-size: 13px !important; /* Noticeably smaller text */
            font-weight: 500 !important;
            color: #cccccc !important; /* Light text color font swap */
        }

        /* Force chevron arrow icon inside the info container block to match styles */
        div[data-testid="stExpander"]:has(span:contains("ℹ️")) summary svg,
        div[data-testid="stExpander"]:has(p:contains("ℹ️")) summary svg {
